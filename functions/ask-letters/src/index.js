...
async function getNewGameIntent() {
  ...
  let tempArray = new Array(Letters.length);
  ...
  for (let u = 0; u < Letters.length; u++) {
    tempArray[u] = Letters[u];
  }
  tempArray = shuffle(tempArray);
  /* eslint-disable */
  this.attributes.dataToSave = {
    randomArray: tempArray, inorderArray: Letters, randomIndex: randomIndex, inorderIndex: inorderIndex, numerate: numerate, score: score, totalscore: totalscore,
  };
  /* eslint-enable */
  try {
...
async function randomGameIntent() {
  ...
  const smallimageurl = randomArray[0][4];
  const largeimageurl = randomArray[0][5];
  /* eslint-disable */
  savedData = {
...
async function inorderGameIntent() {
  ...
  let savedData = this.attributes.dataToSave;
  const randomArray = savedData.randomArray;
  const inorderNumber = Letters[0][0];
  const smallimageurl = Letters[0][4];
  const largeimageurl = Letters[0][5];
  /* eslint-disable */
  savedData = {
    randomArray: randomArray, inorderArray: Letters, randomIndex: randomIndex, inorderIndex: inorderIndex, numerate: numerate, score: score, totalscore: totalscore,
  };
